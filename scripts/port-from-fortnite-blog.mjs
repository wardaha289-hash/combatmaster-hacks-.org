#!/usr/bin/env node
/**
 * Ports the 8 posts from ../combatmaster-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'combatmaster-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'combatmaster intel'],
...
const file = `/* Auto-generated by scripts/port-from-combatmaster-blog.mjs — do not edit by hand. */
