...
export const PAGE_IMAGE_ALTS = {
	...
	'combatmaster-esp': 'Combat Master ESP player boxes and distance readouts in a match',
	'combatmaster-aimbot': 'Combat Master aimbot and soft aim controls on Windows PC',
	...
	setup: 'Combat Master Hacks Setup screenshot for Windows PC',
	updates: 'Combat Master Hacks live status after game patches and game patches',
	...
	undetected: 'Combat Master Hacks live status overview for Windows PC',
	...
	'anti-cheat': 'Combat Master Hacks maintenance after a game patch',
