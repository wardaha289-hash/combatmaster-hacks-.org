...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-combatmasterhacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'combatmaster-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'combatmaster-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'combatmaster-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'combatmaster-aimbot-skeleton.webp',
	},
	{
		source:
		...
		file: 'combatmaster-esp-radar.webp',
	},
	{
		source:
		...
		file: 'combatmaster-hacks-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'combatmaster-battle-royale-combat',
	'combatmaster-team-deathmatch',
	'combatmaster-hacks-aimbot',
	'combatmaster-hacks-cover',
	'combatmaster-hacks-esp-wallhack',
	'combatmaster-hacks-hero',
	'combatmaster-hacks-logo',
	'combatmaster-hacks-package',
	'combatmaster-header-art',
	'combatmaster-loadout-builder',
	'combatmaster-player-esp',
	'combatmaster-quick-play-combat',
	'combatmaster-battle-royale-mode',
	'combatmaster-squad-fight',
	'combatmaster-verdansk-map',
];

async function removeOldCombat MasterImages() {
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'combatmaster-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `combatmaster-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'combatmaster-esp-player-tags.webp') continue;
...
await removeOldCombat MasterImages();
