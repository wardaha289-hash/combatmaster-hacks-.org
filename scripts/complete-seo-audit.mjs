#!/usr/bin/env node
/**
 * Completes escape-from-combatmaster-hacks SEO audit: add missing pages, fix leftovers, strip Zadeyo from meta.
...
const EXTRA_PAGES = [
	{ id: 'hacks', dir: 'combatmaster-hacks', pageId: 'hacks' },
	{ id: 'cheat-download', dir: 'combatmaster-cheat-download', pageId: 'cheat-download' },
	{ id: 'mod-menu', dir: 'combatmaster-mod-menu', pageId: 'mod-menu' },
	{ id: 'soft-aim', dir: 'combatmaster-soft-aim', pageId: 'soft-aim' },
	{ id: 'best-cheats', dir: 'best-combatmaster-hacks', pageId: 'best-cheats' },
	{ id: 'aimbot-hack', dir: 'combatmaster-aimbot-hack', pageId: 'aimbot-hack' },
	{ id: 'esp-hack', dir: 'combatmaster-esp-hack', pageId: 'esp-hack' },
	{ id: 'unlock-all', dir: 'combatmaster-unlock-all', pageId: 'unlock-all' },
];

const GLOBAL_REPLACEMENTS = [
	[/combatmaster-combatmaster/g, 'combatmaster'],
	[/anti-cheat-bypass-combatmaster/g, 'anti-cheat-bypass'],
	...
	[/Combat Master anti-cheat/g, 'Combat Master anti-cheat'],
	...
	[/anti-cheat/g, 'anti-cheat'],
	[/escape-from-combatmaster-hacks/g, 'escape-from-combatmaster-hacks'],
	[/escape-from-combatmaster/g, 'combatmaster'],
