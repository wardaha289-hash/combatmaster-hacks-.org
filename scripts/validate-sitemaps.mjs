...
const REDIRECT_ONLY_PATHS = new Set([
	'/best-combatmaster-hacks/',
	'/combatmaster-aimbot-hack/',
	'/combatmaster-esp-hack/',
	'/combatmaster-hacks-2026/',
	'/undetected-combatmaster-hacks/',
	'/combatmaster-mod-menu/',
	'/combatmaster-unlock-all/',
	'/combatmaster-soft-aim/',
	'/combatmaster-wallhack/',
	'/combatmaster-cheat-download/',
	'/anti-cheat-bypass/',
]);
...
const ENGLISH_PATHS = [
	...
	'/terms/',
	'/blog/',
	'/blog/combatmaster-scav-run-aggressive-strategies/',
	'/blog/combatmaster-loot-routes-guide/',
	'/blog/combatmaster-weapon-tier-list/',
	'/blog/combatmaster-skin-leaks-guide/',
	'/blog/combatmaster-tournament-meta-guide/',
	'/blog/combatmaster-pro-settings-guide/',
	'/blog/combatmaster-warmup-maps-ranked/',
	'/blog/combatmaster-patch-notes-guide/',
	'/blog/combatmaster-hacks-complete-guide-2026/',
	'/blog/escape-from-combatmaster-hacks-buyers-guide/',
	'/blog/combatmaster-hacks-2026-whats-new/',
	'/blog/combatmaster-aimbot-settings-guide/',
	'/blog/combatmaster-esp-wallhack-explained/',
	'/blog/undetected-combatmaster-hacks-anti-cheat/',
	'/blog/combatmaster-hacks-vs-cheatvault-comparison/',
	'/blog/elitefn-vs-combatmaster-hacks-two-week-test/',
	'/blog/combatmaster-hacks-vs-ghostware-features-pricing/',
	'/reviews/',
	'/reviews/combatmaster-soft-aim-review-xkrypt0/',
	'/reviews/combatmaster-esp-scav-run-review-buildsr4k/',
	'/reviews/combatmaster-cloud-dma-review-dma-wizard/',
	'/reviews/combatmaster-soft-aim-review-ctrl-player99/',
	'/reviews/combatmaster-cheat-setup-review-stormchaser07/',
	'/reviews/combatmaster-loot-esp-review-lootgoblinx/',
	'/reviews/combatmaster-soft-aim-match-review-rankedgrind42/',
	'/reviews/combatmaster-radar-hack-review-vanlifeeft/',
	'/reviews/combatmaster-anti-cheat-update-review-patchdaymike/',
	'/reviews/combatmaster-sniper-soft-aim-review-snipezonly/',
	'/faq/what-are-combatmaster-hacks/',
	'/faq/are-combatmaster-hacks-undetected-in-2026/',
	'/faq/pmc-matchs-and-scav-runs/',
	'/faq/esp-wallhack-radar-or-aimbot/',
	'/faq/how-are-licenses-delivered/',
	'/faq/where-to-check-updates/',
	'/faq/how-to-contact-support/',
	'/faq/what-is-a-combatmaster-wallhack/',
	'/faq/does-combatmaster-hacks-include-radar-hack/',
	'/faq/anti-cheat-anti-cheat-and-combatmaster-hacks/',
	'/faq/buy-undetected-combatmaster-hacks-windows-pc/',
];
...
function matchHreflangCount(xml, url) {
...
async function main() {
	...
	const indexLocs = matchLocs(sitemapIndex);
	const enLocs = matchLocs(sitemapEn);
	const i18nLocs = matchLocs(sitemapI18n);
	const imageLocs = matchLocs(sitemapImages);
	...
	const homeHreflang = matchHreflangCount(sitemapEn, `${SITE}/`);
