...
const CANONICAL_ORIGIN = 'https://combatmasterhacks.org';
const APEX_HOST = 'combatmasterhacks.org';
const WWW_HOST = 'www.combatmasterhacks.org';

/** Legacy domains → canonical apex (301). */
const LEGACY_HOSTS = new Set([
	'bestcombatmastercheats.com',
	'www.bestcombatmastercheats.com',
	'fortnitehack.net',
...
const PATH_REDIRECTS = {
	...
	'/escape-from-combatmaster-hacks': '/combatmaster-hacks/',
	'/escape-from-combatmaster-hacks/': '/combatmaster-hacks/',
	// Cannibalization → canonical landings (money URL = /combatmaster-hacks/)
	...
	'/best-combatmaster-hacks/': '/combatmaster-hacks/',
	'/combatmaster-hacks-2026': '/combatmaster-hacks/',
	'/combatmaster-hacks-2026/': '/combatmaster-hacks/',
	'/undetected-combatmaster-hacks': '/combatmaster-hacks/',
	'/undetected-combatmaster-hacks/': '/combatmaster-hacks/',
	'/combatmaster-mod-menu': '/combatmaster-hacks/',
	'/combatmaster-mod-menu/': '/combatmaster-hacks/',
	'/combatmaster-unlock-all': '/combatmaster-hacks/',
	'/combatmaster-unlock-all/': '/combatmaster-hacks/',
	'/combatmaster-soft-aim': '/combatmaster-aimbot/',
	'/combatmaster-soft-aim/': '/combatmaster-aimbot/',
	'/combatmaster-wallhack': '/combatmaster-esp/',
	'/combatmaster-wallhack/': '/combatmaster-esp/',
	'/combatmaster-cheat-download': '/setup/',
	'/combatmaster-cheat-download/': '/setup/',
	'/anti-cheat-bypass': '/updates/',
	'/anti-cheat-bypass/': '/updates/',
	'/warzone-cheats': '/combatmaster-hacks/',
	'/warzone-cheats/': '/combatmaster-hacks/',
	'/warzone-hacks': '/combatmaster-hacks/',
	'/warzone-hacks/': '/combatmaster-hacks/',
	'/warzone-esp': '/combatmaster-esp/',
	'/warzone-esp/': '/combatmaster-esp/',
	'/warzone-aimbot': '/combatmaster-aimbot/',
	'/warzone-aimbot/': '/combatmaster-aimbot/',
	'/ricochet-bypass': '/updates/',
	'/ricochet-bypass/': '/updates/',
	'/fortnite-aimbot': '/combatmaster-aimbot/',
	'/fortnite-aimbot/': '/combatmaster-aimbot/',
	'/fortnite-esp': '/combatmaster-esp/',
	'/fortnite-esp/': '/combatmaster-esp/',
	'/fortnite-hacks': '/combatmaster-hacks/',
	'/fortnite-hacks/': '/combatmaster-hacks/',
	'/eac-bypass': '/updates/',
	'/eac-bypass/': '/updates/',
	'/eac-bypass-fortnite': '/updates/',
	'/eac-bypass-fortnite/': '/updates/',
	'/blog/patch-notes-buffs-nerfs-vaults': '/blog/combatmaster-patch-notes-guide/',
	'/blog/patch-notes-buffs-nerfs-vaults/': '/blog/combatmaster-patch-notes-guide/',
	'/blog/chapter-7-season-3-skin-leaks-vbucks': '/blog/combatmaster-skin-leaks-guide/',
	'/blog/chapter-7-season-3-skin-leaks-vbucks/': '/blog/combatmaster-skin-leaks-guide/',
	'/blog/hammer-ar-s-tier-data-analysis': '/blog/combatmaster-weapon-tier-list/',
	'/blog/hammer-ar-s-tier-data-analysis/': '/blog/combatmaster-weapon-tier-list/',
	'/blog/zero-build-meta-broken-aggressive-strategies': '/blog/combatmaster-scav-run-aggressive-strategies/',
	'/blog/zero-build-meta-broken-aggressive-strategies/': '/blog/combatmaster-scav-run-aggressive-strategies/',
	'/blog/fncs-meta-watch-tournament-drops': '/blog/combatmaster-tournament-meta-guide/',
	'/blog/fncs-meta-watch-tournament-drops/': '/blog/combatmaster-tournament-meta-guide/',
	'/blog/secret-loot-routes-full-gold': '/blog/combatmaster-loot-routes-guide/',
	'/blog/secret-loot-routes-full-gold/': '/blog/combatmaster-loot-routes-guide/',
	'/blog/bugha-settings-pro-setup': '/blog/combatmaster-pro-settings-guide/',
	'/blog/bugha-settings-pro-setup/': '/blog/combatmaster-pro-settings-guide/',
	'/blog/creative-warmup-maps-pros-use': '/blog/combatmaster-warmup-maps-ranked/',
	'/blog/creative-warmup-maps-pros-use/': '/blog/combatmaster-warmup-maps-ranked/',
	'/reviews/combatmaster-esp-zero-build-review-buildsr4k': '/reviews/combatmaster-esp-scav-run-review-buildsr4k/',
	'/reviews/combatmaster-esp-zero-build-review-buildsr4k/': '/reviews/combatmaster-esp-scav-run-review-buildsr4k/',
	'/reviews/combatmaster-radar-hack-review-vanlifefn': '/reviews/combatmaster-radar-hack-review-vanlifeeft/',
	'/reviews/combatmaster-radar-hack-review-vanlifefn/': '/reviews/combatmaster-radar-hack-review-vanlifeeft/',
	'/reviews/combatmaster-radar-hack-review-vanlifewz': '/reviews/combatmaster-radar-hack-review-vanlifeeft/',
	'/reviews/combatmaster-radar-hack-review-vanlifewz/': '/reviews/combatmaster-radar-hack-review-vanlifeeft/',
	'/reviews/combatmaster-controller-soft-aim-review-ctrl-player99': '/reviews/combatmaster-soft-aim-review-ctrl-player99/',
	'/reviews/combatmaster-controller-soft-aim-review-ctrl-player99/': '/reviews/combatmaster-soft-aim-review-ctrl-player99/',
};
