...
export const heroResponsive: ResponsiveWidth[] = [
	{ src: '/images/combatmaster-hacks-hero-640w.webp', width: 640 },
	{ src: '/images/combatmaster-hacks-hero-960w.webp', width: 960 },
	{ src: '/images/combatmaster-hacks-hero-1024w.webp', width: 1024 },
];

export const heroDesktopResponsive: ResponsiveWidth[] = heroResponsive;

/** Default LCP src — full native WebP (1024w). */
export const heroSrc = '/images/combatmaster-hacks-hero-1024w.webp';
export const heroSrcSet = buildSrcSet(heroResponsive);
export const heroSizes = '100vw';

/** LCP preload — highest ladder WebP. */
