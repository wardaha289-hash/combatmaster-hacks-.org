...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	en: {
		eyebrow: 'combatmaster hacks',
		title: 'combatmaster hacks gallery',
		subtitle: 'Simple combatmaster hacks visuals — ESP, wallhack, aimbot, and radar for Combat Master on PC.',
		lead: 'Combat Master Hacks helps you spot players, bots, loot, and matchs with ESP, aimbot, and radar in one license.',
		highlights: [
			{ title: 'combatmaster hacks esp', copy: 'See players through walls with combatmaster hacks esp and wallhack overlays.' },
			{ title: 'combatmaster hacks radar', copy: 'Track nearby threats with combatmaster hacks radar before you push or match.' },
			{ title: 'combatmaster hacks aimbot', copy: 'Use soft aim and aimbot controls tuned for Combat Master matchs on Windows PC.' },
		],
		updatesLabel: 'combatmaster hacks updates',
	...
	es: {
		...
		lead: 'Combat Master Hacks está pensado para el loop BR de Combat Master: leer el mapa, rastrear escuadrones enemigos, lootear y sobrevivir al match.',
		highlights: [
			{ title: 'ESP de players y escuadrones', copy: 'Detecta players enemigos y contornos de escuadrón en Battle Royale y scav-run para elegir peleas con mejor información.' },
	...
	fr: {
		...
		lead: 'Combat Master Hacks suit la boucle BR de Combat Master : lire la carte, suivre les escouades, loot et survivre au match.',
		highlights: [
			{ title: 'ESP players & escouades', copy: 'Repérez les players ennemis sur Battle Royale et scav-run pour choisir vos engagements.' },
	...
	de: {
		...
		highlights: [
			{ title: 'Player- & Squad-ESP', copy: 'Erkenne feindliche Playeren auf Battle Royale und scav-run für bessere Rotationsentscheidungen.' },
	...
	pt: {
		...
		lead: 'Combat Master Hacks segue o loop BR do Combat Master: ler o mapa, rastrear esquadrões, lootar e sobreviver ao match.',
		highlights: [
			{ title: 'ESP de players e esquadrões', copy: 'Detecte players inimigos em Battle Royale e scav-run para escolher lutas com melhor intel.' },
	...
	it: {
		...
		lead: 'Combat Master Hacks è pensato per il loop BR di Combat Master: leggere la mappa, tracciare squadre nemiche, loot e sopravvivere al match.',
		highlights: [
			{ title: 'ESP playeri e squadre', copy: 'Individua playeri nemici su Battle Royale e scav-run per scegliere i fight con più intel.' },
	...
	nl: {
		...
		lead: 'Combat Master Hacks volgt de match-loop van Combat Master: kaart lezen, vijandelijke squads volgen, looten en de match overleven.',
		highlights: [
			{ title: 'Player- & squad-ESP', copy: 'Spot vijandelijke players op Battle Royale en scav-run voor betere rotatiebeslissingen.' },
	...
	pl: {
		...
		lead: 'Combat Master Hacks pasuje do pętli BR Combat Master: czytaj mapę, śledź wrogie drużyny, lootuj i przeżyj match.',
		highlights: [
			{ title: 'ESP players i drużyn', copy: 'Wykrywaj wrogich players na Battle Royale i scav-run dla lepszych decyzji rotacyjnych.' },
	...
	ru: {
		...
		lead: 'Combat Master Hacks создан для рейд-циклу Combat Master: читать карту, отслеживать вражеские отряды, лут и выживать в match.',
		highlights: [
			{ title: 'ESP игроков и отрядов', copy: 'Замечайте вражеских игроков на Battle Royale и scav-run для лучших решений по ротации.' },
	...
	tr: {
		...
		lead: 'Combat Master Hacks, Combat Master BR döngüsü için: haritayı oku, düşman takımları izle, loot al ve match\'da hayatta kal.',
		highlights: [
			{ title: 'Player ve takım ESP', copy: 'Battle Royale ve scav-run\'da düşman playerleri görerek daha iyi rotasyon kararları alın.' },
	...
	ar: {
		...
		lead: 'Combat Master Hacks مبني لحلقة BR في Combat Master: قراءة الخريطة، تتبع الفرق، جمع اللوت والنجاة في match.',
		highlights: [
			{ title: 'ESP للمشغلين والفرق', copy: 'اكتشف players المعادين على Battle Royale وscav-run لاختيار القتالات بذكاء.' },
	...
	ja: {
		...
		lead: 'Combat Master HacksはCombat MasterのBRループ向け：マップを読み、敵スクワッドを追跡し、ルートしてmatchを生き延びる。',
		highlights: [
			{ title: 'players＆スクワッドESP', copy: 'Battle Royaleとscav-runで敵playersを把握し、ローテ判断を改善。' },
	...
	ko: {
		...
		lead: 'Combat Master Hacks는 Combat Master BR 루프용: 맵 읽기, 적 스쿼드 추적, 루트 수집, match 생존.',
		highlights: [
			{ title: 'players & 스쿼드 ESP', copy: 'Battle Royale와 scav-run에서 적 players를 파악해 로테이션 결정을 개선.' },
	...
	zh: {
		...
		lead: 'Combat Master Hacks 为 Combat Master BR 循环设计：读图、追踪敌方小队、搜刮并在 match 存活。',
		highlights: [
			{ title: 'players与小队 ESP', copy: '在 Battle Royale 和 scav-run 发现敌方players，做出更好的转点决策。' },
	...
	hi: {
		...
		lead: 'Combat Master Hacks Combat Master BR loop के लिए: map पढ़ें, enemy squads track करें, loot करें और match survive करें।',
		highlights: [
			{ title: 'Player & Squad ESP', copy: 'Battle Royale और scav-run पर enemy players spot करें बेहतर rotation decisions के लिए।' },
	...
	id: {
		...
		lead: 'Combat Master Hacks untuk loop BR Combat Master: baca peta, lacak squad musuh, loot, dan selamat di match.',
		highlights: [
			{ title: 'ESP player & squad', copy: 'Deteksi player musuh di Battle Royale dan scav-run untuk keputusan rotasi lebih baik.' },
	...
	th: {
		...
		lead: 'Combat Master Hacks สำหรับลูป BR ของ Combat Master: อ่านแผนที่ ติดตามทีมศัตรู เก็บ loot และรอด match',
		highlights: [
			{ title: 'ESP ผู้เล่นและทีม', copy: 'มองเห็นศัตรูบน Battle Royale และ scav-run เพื่อตัดสินใจหมุนเวียนได้ดีขึ้น' },
	...
	vi: {
		...
		lead: 'Combat Master Hacks cho vòng BR Combat Master: đọc bản đồ, theo dõi squad địch, loot và sống sót match.',
		highlights: [
			{ title: 'ESP player & squad', copy: 'Phát hiện player địch trên Battle Royale và scav-run để quyết định rotate tốt hơn.' },
	...
	uk: {
		...
		lead: 'Combat Master Hacks для рейд-циклу Combat Master: читати карту, відстежувати ворожі загони, лут і виживати в match.',
		highlights: [
			{ title: 'ESP гравців і загонів', copy: 'Помічайте ворожих гравців на Battle Royale і scav-run для кращих ротацій.' },
	...
	cs: {
		...
		lead: 'Combat Master Hacks pro BR smyčku Combat Master: číst mapu, sledovat nepřátelské squady, loot a přežít match.',
		highlights: [
			{ title: 'ESP players a squadů', copy: 'Spozorujte nepřátelské operátory na Battle Royale a scav-run pro lepší rotační rozhodnutí.' },
	...
	ro: {
		...
		lead: 'Combat Master Hacks pentru bucla BR Combat Master: citește harta, urmărește squad-uri inamice, loot și supraviețuiește match.',
		highlights: [
			{ title: 'ESP playeri și squad-uri', copy: 'Detectează playeri inamici pe Battle Royale și scav-run pentru decizii de rotație mai bune.' },
	...
	sv: {
		...
		lead: 'Combat Master Hacks för Combat Master:s match-loop: läs kartan, spåra fiendesquads, loota och överlev match.',
		highlights: [
			{ title: 'Player- & squad-ESP', copy: 'Spotta fiendeplayerer på Battle Royale och scav-run för bättre rotationsbeslut.' },
