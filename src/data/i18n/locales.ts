...
> = {
	en: {
		...
		blogDescription:
			'Combat Master guides — match tips, ESP, aimbot notes, loot routes, and game update coverage. English blog at combatmasterhacks.org/blog/.',
		blogH1: 'Combat Master Hacks Intel',
		blogIntro:
			'Short Combat Master guides for Battle Royale and multiplayer modes. Pair these tips with the Combat Master Hacks product pages when you need ESP, soft aim, or radar.',
		readMore: 'Read guide',
		published: 'Published',
		updated: 'Updated',
	...
	es: {
		...
		blogIntro:
			'Guías SEO de trucos Combat Master indetectables, ESP wallhack, radar hack, Aimbot y mantenimiento anti-cheat en 22 idiomas.',
		readMore: 'Leer guía',
		published: 'Publicado',
		updated: 'Actualizado',
	...
	fr: {
		...
		blogIntro:
			'Guides SEO triches Combat Master indétectables, ESP wallhack, radar hack, Aimbot et anti-cheat en 22 langues.',
	...
	de: {
		...
		blogIntro:
			'SEO-Guides für undetected Combat Master Hacks, ESP Wallhack, Radar Hack, Aimbot und anti-cheat in 22 Sprachen.',
	...
	pt: {
		...
		blogIntro:
			'Guias SEO de cheats Combat Master indetectáveis, ESP wallhack, radar hack, Aimbot e anti-cheat em 22 idiomas.',
		readMore: 'Ler guia',
		published: 'Publicado',
		updated: 'Atualizado',
	...
	it: {
		...
		blogIntro:
			'Guide SEO cheat Combat Master indetectable, ESP wallhack, radar hack, Aimbot e anti-cheat in 22 lingue.',
	...
	nl: {
		...
		blogIntro:
			'SEO-gidsen voor undetected combatmaster hacks, ESP wallhack, radar hack, Aimbot en anti-cheat in 22 talen.',
		readMore: 'Lees gids',
	...
	pl: {
		...
		blogIntro:
			'Poradniki SEO undetected cheatów Combat Master, ESP wallhack, radar hack, Aimbot i anti-cheat w 22 językach.',
	...
	ru: {
		...
		blogIntro:
			'SEO-гайды по undetected читам Combat Master, ESP wallhack, radar hack, Aimbot и anti-cheat на 22 языках.',
	...
	tr: {
		...
		blogIntro:
			'Undetected Combat Master hileleri, ESP wallhack, radar hack, Aimbot ve anti-cheat SEO rehberleri 22 dilde.',
	...
	ar: {
		...
		blogIntro:
			'أدلة SEO لغش Combat Master undetected وESP wallhack ورadar hack وAimbot وanti-cheat بـ 22 لغة.',
	...
	ja: {
		...
		blogIntro:
			'undetected Combat Masterチート、ESP wallhack、radar hack、Aimbot、anti-cheatのSEOガイドを22言語で提供。',
		readMore: 'ガイドを読む',
		published: '公開日',
		updated: '更新日',
	...
	ko: {
		...
		blogIntro:
			'undetected Combat Master 치트, ESP wallhack, radar hack, Aimbot, anti-cheat SEO 가이드를 22개 언어로 제공.',
		readMore: '가이드 읽기',
		published: '게시일',
		updated: '업데이트',
	...
	zh: {
		...
		blogIntro:
			'undetected Combat Master作弊、ESP wallhack、radar hack、Aimbot和anti-cheat的SEO指南，共22种语言。',
		readMore: '阅读指南',
		published: '发布',
		updated: '更新',
	...
	hi: {
		...
		blogIntro:
			'undetected combatmaster hacks, ESP wallhack, radar hack, Aimbot और anti-cheat SEO गाइड 22 भाषाओं में।',
		readMore: 'गाइड पढ़ें',
		published: 'प्रकाशित',
		updated: 'अपडेट',
	...
	id: {
		...
		blogIntro:
			'Panduan SEO cheat Combat Master undetected, ESP wallhack, radar hack, Aimbot dan anti-cheat dalam 22 bahasa.',
	...
	th: {
		...
		blogIntro:
			'คู่มือ SEO สำหรับ cheat Combat Master undetected, ESP wallhack, radar hack, Aimbot และ anti-cheat 22 ภาษา',
		readMore: 'อ่านคู่มือ',
		published: 'เผยแพร่',
		updated: 'อัปเดต',
	...
	vi: {
		...
		blogIntro:
			'Hướng dẫn SEO cheat Combat Master undetected, ESP wallhack, radar hack, Aimbot và anti-cheat bằng 22 ngôn ngữ.',
	...
	uk: {
		...
		blogIntro:
			'SEO-гайди з undetected читів Combat Master, ESP wallhack, radar hack, Aimbot та anti-cheat 22 мовами.',
	...
	cs: {
		...
		blogIntro:
			'SEO průvodce undetected combatmaster hacky, ESP wallhack, radar hack, Aimbot a anti-cheat ve 22 jazycích.',
	...
	ro: {
		...
		blogIntro:
			'Ghiduri SEO cheat-uri Combat Master undetected, ESP wallhack, radar hack, Aimbot și anti-cheat în 22 de limbi.',
	...
	sv: {
		...
		blogIntro:
			'SEO-guider för undetected combatmaster hacks, ESP wallhack, radar hack, Aimbot och anti-cheat på 22 språk.',
		readMore: 'Läs guide',
