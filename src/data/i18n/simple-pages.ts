...
export const simplePageCopy: Partial<Record<PageId, SimplePageCopy>> = {
		...
		sections: [
			{
				h2: 'ESP & wallhack',
				paragraphs: [
					'See players, bots, bosses, and loot through walls with distance readouts.',
					'Use filters so the overlay stays clear in TDM, Factory, and scav-run chaos.',
				],
				list: ['Player boxes & distance', 'Loot and match markers', 'Boss and Scav filters'],
			},
			{
				h2: 'Aimbot & soft aim',
				paragraphs: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Spot flanks near matchs without filling the whole screen.',
				],
				list: ['Nearby enemy cues', 'Adjustable range', 'Works in BR & TDM'],
			},
			{
				h2: 'Updates & support',
				paragraphs: [
				...
				list: ['Status on the Status page', 'Setup included', 'Email support with your order ID'],
			},
		],
	}),
	pricing: page({
	...
	updates: page({
		...
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Combat Master Hacks overview',
		...
		sections: [
			{
				h2: 'Current status',
				paragraphs: [
					'As of 13 Aug 2026 the package is online for Combat Master on Windows PC. We post a new note here when a game or game patch needs a rebuild.',
		...
		sections: [
			{
				h2: 'What you get',
				paragraphs: [
					'One license for Combat Master on Windows PC — built for Battle Royale and multiplayer modes.',
				],
				list: [
			...
			{
				h2: 'Built for Combat Master matchs',
				paragraphs: [
					'Read players and bots before you push, mark loot worth the risk, and stay aware near matchs. Tune soft aim per weapon class for dorms, Factory, and long-range maps.',
				],
				list: [
					'<a href="/combatmaster-esp/">ESP page</a>',
					'<a href="/combatmaster-aimbot/">Aimbot controls</a>',
					'<a href="/combatmaster-radar-hack/">Radar overlay</a>',
	...
	'combatmaster-esp': page({
		title: 'Combat Master ESP | {brand}',
		description:
			'Combat Master ESP and wallhack for Combat Master on Windows PC — player boxes, distance, loot filters, and clear overlays in matchs.',
		h1: 'ESP',
		intro: 'See players and loot through walls during Combat Master matchs. Part of the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Combat Master Hacks overview',
		ctaSecondaryHref: '/combatmaster-hacks/',
		...
		sections: [
			{
				h2: 'What ESP shows',
				paragraphs: ['Boxes, distance, and filters for players, bots, bosses, and loot.'],
				list: ['Player ESP', 'Loot markers', 'Boss and Scav filters'],
			},
			{
				h2: 'When to use it',
				paragraphs: ['Clear dorms, Factory, and quick plays without flooding the screen.'],
			...
			},
			{
				...
				list: [
					'<a href="/combatmaster-hacks/">Full product</a>',
	...
	'combatmaster-aimbot': page({
		title: 'Combat Master Aimbot | {brand}',
		description:
			'Combat Master aimbot and soft aim for Combat Master on Windows PC — FOV, smoothness, and bone priority you can tune per weapon.',
		h1: 'Aimbot',
		intro: 'Soft aim and aim assist you can tune for Combat Master. Included in the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Combat Master Hacks overview',
		ctaSecondaryHref: '/combatmaster-hacks/',
	...
	radar: page({
		title: 'Combat Master Radar | {brand}',
		description:
			'Combat Master 2D radar for Combat Master on Windows PC — flank cues near matchs without filling the whole screen.',
		h1: 'Radar',
		...
		sections: [
			{
				h2: 'What it shows',
				paragraphs: ['Nearby enemy cues with adjustable range for players and bots runs.'],
	...
	faq: page({
		...
		sections: [
			...
			},
			{
				...
				list: ['<a href="/setup/">Setup</a>', '<a href="/updates/">Status</a>'],
			},
			{
				h2: 'Refunds',
