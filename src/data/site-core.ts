...
export const productInfo = {
	...
	features: {
		esp: [
			'Player ESP / wallhack',
			'Enemy name and health cues',
			'Distance readouts',
			'Toggleable ESP categories',
			'Team and enemy filters',
			'Works in Battle Royale and TDM',
		],
		aimbot: [
			'Aimbot with smoothness controls',
			'FOV and bone priority settings',
			'No recoil and spread control',
			'Hotkeys mid-match',
			'Per-weapon profiles',
		],
		radar: ['Radar minimap overlay', 'Adjustable range', 'Killstreak tracker', 'Works in all game modes'],
		general: [
