...
const imageMap: Record<BlogImageKey, string> = {
	hero: combatmasterImages.espWallhack,
	espWallhack: combatmasterImages.espWallhack,
	aimbotCombat: combatmasterImages.aimbotCombat,
	aimbotSkeleton: combatmasterImages.aimbotSkeleton,
	squadFight: combatmasterImages.aimbotCombat,
	headerArt: combatmasterImages.playerEsp,
	cheatsPackage: combatmasterImages.espWallhack,
	playerEsp: combatmasterImages.playerEsp,
	rebootFight: combatmasterImages.aimbotCombat,
	battleRoyaleCombat: combatmasterImages.cheatsCombat,
	battleRoyaleIslandMap: combatmasterImages.espWallhack,
};

const FALLBACK_BLOG_IMAGE = combatmasterImages.espWallhack;
...
export function getBlogSitemapEntriesForLocale(locale: LocaleCode) {
	...
	for (const post of blogPosts) {
		...
		const isProductPost = /Combat Master Hacks|Aimbot|ESP|Undetected|Comparisons/i.test(post.category);
		entries.push({
