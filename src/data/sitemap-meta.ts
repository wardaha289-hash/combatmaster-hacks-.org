 ...
 * `lastmod` reflects when anti-cheat page's content actually changed — do NOT reset all
...
export const pageSitemapMeta: Record<PageId, PageSitemapMeta> = {
	...
	/** Money URL for "combatmaster hacks" */
	...
	'anti-cheat': { priority: 0.3, changefreq: 'yearly', i18nPriority: 0.2, lastmod: '2026-08-13' },
	'combatmaster-esp': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-13' },
	'combatmaster-aimbot': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-13' },
