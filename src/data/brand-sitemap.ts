...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'combatmaster hacks esp',
		caption: 'combatmaster hacks esp wallhack',
	},
	{
		src: '/images/combatmaster-hacks-wallhack.webp',
		title: 'combatmaster hacks wallhack',
		caption: 'combatmaster hacks wallhack esp',
	},
	{
		src: '/images/combatmaster-hacks-aimbot.webp',
		title: 'combatmaster hacks aimbot',
		caption: 'combatmaster hacks aimbot soft aim',
	},
	{
		src: '/images/combatmaster-hacks-aimbot-view.webp',
		title: 'combatmaster hacks aimbot',
		caption: 'combatmaster hacks aimbot view',
	},
	{
		src: '/images/combatmaster-hacks-radar.webp',
		title: 'combatmaster hacks radar',
		caption: 'combatmaster hacks radar hack',
	},
	{
		src: '/images/combatmaster-hacks-match.webp',
		title: 'combatmaster hacks',
		caption: 'combatmaster hacks in match',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Combat Master', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'combatmaster-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'combatmaster-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	updates: { title: '{primaryKeyword} live status', caption: 'Check {primaryKeyword} after a game or game patch' },
	...
	'anti-cheat': { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after a game update' },
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Combat Master on PC' },
