...
function HeroInner({
	...
	const ctaPrimary = useBrandHero ? t('hero.exploreNow') : t('hero.buyNow');
	const ctaHref = useBrandHero ? '/features/' : checkoutUrl;
				...
				<div className="hero__copy">
					...
					<div className="hero__actions">
						<a
							className="hero__buy"
							href={ctaHref}
							{...(useBrandHero ? {} : { rel: 'noopener noreferrer' })}
						>
							{useBrandHero ? (
								<span className="hero__buy-label" data-edit="ctaExplore">
									{ctaPrimary}
								</span>
							) : (
								<>
									...
									<span className="hero__buy-label">{ctaPrimary}</span>
